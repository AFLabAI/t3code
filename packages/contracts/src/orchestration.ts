...
export const ProviderInteractionMode = Schema.Literals(["default", "plan", "council"]);
...
export const ThreadCouncilGoalRequestedPayload = Schema.Struct({
  threadId: ThreadId,
  goalText: TrimmedNonEmptyString,
  createdAt: IsoDateTime,
});
